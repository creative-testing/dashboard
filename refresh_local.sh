...
echo "📥 Fetch des données (14 derniers jours pour inclure la semaine précédente)..."
TAIL_BACKFILL_DAYS=14 FRESHNESS_BUFFER_HOURS=1 python3 scripts/production/fetch_with_smart_limits.py
