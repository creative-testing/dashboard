        ...
        function generateDemographicsFromCurrentData(accountId, period) {
            ...
            if (accountId === 'Petcare 2' || accountId === 'act_297112083495970') {
                ...
                // Triés par Inversión décroissante (du plus grand au plus petit)
            ...
            const data = window.periodsData[period];
        ...
        // Demographics loading function - Load pre-calculated JSON (ChatGPT-5 recommendation)
